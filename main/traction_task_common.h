...
#define VEHICLE_TEST_TASK_PRIORITY      3
...
#define TRACTION_M_RIGHT_MAX_SPEED_REVS      1.03
#define TRACTION_M_LEFT_MAX_SPEED_REVS       5.876

#define TRACTION_M_RIGHT_REVS2PULSES         20 / 1.03
